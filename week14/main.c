...
// ----- EX. 4 : player ------------
        ...
        //step 2-4. coin
        int coincount=board_getBoardCoin(player_position[turn]);
        player_coin[turn]+=coincount;
        printf("%s gets %d coins! Total coins: %d\n", player_name[turn], coincount, player_coin[turn]);
